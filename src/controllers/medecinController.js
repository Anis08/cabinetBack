  ...
  try {
    ...
    const [patient, nextAppointment] = await prisma.$transaction([
      ...
      select: {
        ...
        fullName: true,
        phoneNumber: true,
        // email: true,  // DISABLED: Will be enabled after migration
        // address: true,  // DISABLED: Will be enabled after migration
        gender: true,
        poids: true,
        taille: true,
        dateOfBirth: true,
  ...
  try {
    ...
    const updatedPatient = await prisma.patient.update({
      ...
      data: {
        ...
        // email: email || null,  // DISABLED: Will be enabled after migration
        // address: address || null,  // DISABLED: Will be enabled after migration
